      ...
      <footer className="text-white body-font bg-black">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <Link className="flex title-font font-medium items-center md:justify-start justify-center" href="#">
            ...
            <div className='inline-flex'>
              <Image 
                ...
                width={100} 
              />
              <h1 className='inline-flex pl-5'>Opening Hours: Mon - Sat(8.00 - 6.00), Sunday - Closed</h1>
            </div>
          </div>

          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium tracking-widest text-sm mb-3">Useful Links</h2>
              <nav className="list-none mb-10">
                <li><Link href="#" className="hover:text-gray-800">About</Link></li>
                <li><Link href="#" className="hover:text-gray-800">News</Link></li>
                <li><Link href="#" className="hover:text-gray-800">Partners</Link></li>
                <li><Link href="#" className="hover:text-gray-800">Team</Link></li>
                <li><Link href="#" className="hover:text-gray-800">Menu</Link></li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li><Link href="#" className="hover:text-gray-800">Support Policy</Link></li>
                <li><Link href="#" className="hover:text-gray-800">Privacy</Link></li>
              </nav>
            </div>

            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium tracking-widest text-sm mb-3">Recent Posts</h2>
              <nav className="list-none mb-10">
                <Image 
