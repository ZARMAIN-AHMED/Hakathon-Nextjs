...
const Signup = () => {
    return (
        <div>    <Navbar/>   <section className="bg-white dark:bg-gray-900 min-h-screen flex items-center">
                ...
                <div className="flex flex-wrap w-full max-w-4xl">
                    ...
                    <div className="w-full md:w-1/2 flex items-center justify-center bg-orange-100 dark:bg-gray-800 p-6 rounded-l-lg">
                        <div className="text-center">
                            <h2 className="text-3xl font-semibold text-gray-800 dark:text-white">Welcome to Our Website!</h2>
                        ...
                        <form className="w-full max-w-md mx-auto">
                            ...
                            <div className="mt-6">
                                <Link href={'/homepage'}><button
                                    className=" w-full mb-5 px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-orange-500 rounded-lg hover:bg-orange-400 focus:outline-none focus:ring focus:ring-orange-300 focus:ring-opacity-50"
                                >
                                    Sign up
                                </button></Link>
                                <a
                                        href="#"
                                        className="text-sm text-orange-500 hover:underline dark:text-orange-400 pl-72 py-5"
                                    >
                                       Forget Password
                                    </a>
                                <p className="mt-4 text-center text-gray-600 dark:text-gray-400">OR</p>
