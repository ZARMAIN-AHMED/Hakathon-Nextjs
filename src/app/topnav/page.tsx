        ...
        <nav className="relative bg-black shadow dark:bg-gray-800 h-80 bg-cover bg-center bg-[url('/tomato.png')]">
            <div className="container flex items-center justify-between px-6 py-3 mx-auto">
                ...
                <div className="hidden lg:flex space-x-6 text-white">
                    <Link href="/homepage" className="transition-colors duration-300 transform rounded-lg hover:text-orange-500">
                        Home
                    </Link>
                    <Link href="/menu" className="transition-colors duration-300 transform rounded-lg hover:text-orange-500">
                        Menu
                    </Link>
                    <Link href="blog" className="transition-colors duration-300 transform rounded-lg hover:text-orange-500">
                        Blog
                    </Link>
                    <Link href="/ourchef" className="transition-colors duration-300 transform rounded-lg hover:text-orange-500">
                        Pages
                    ...
                    <Link href="/shop" className="transition-colors duration-300 transform rounded-lg hover:text-orange-500">
                        Shop
                    </Link>
                    <Link href="/sigin" className="transition-colors duration-300 transform rounded-lg hover:text-orange-500">
                    Sign in
                    </Link>
                </div>
            ...
            {/* Mobile Menu */}
            <div
                className={`lg:hidden ${isOpen ? 'block' : 'hidden'} bg-black text-white px-6 py-4`}
            >
